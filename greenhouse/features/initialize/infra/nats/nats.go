...
var (
	...
	RequestByNats = func(hope contract2.IHope) domain.IFbk {
		...
		return contract.Json2Fbk(data)
	}

	hopeHandler = infra.NewHopeHandler(domain2.Root, contract.Hope2Cmd, contract.Json2Hope, contract.Fbk2Json)
